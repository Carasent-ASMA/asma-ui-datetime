import { ChevronDownIcon, ChevronUpIcon, StyledButton, StyledLink, StyledWidgetTitle } from 'asma-ui-datetime'
...
export const StyledWidget: React.FC<PropsWithChildren<StyledWidgetProps>> = ({
    ...
    return (
        <div className={style['asma-ui-datetime-styled-widget']}>
            <div
                className={clsx(
